            ...
            <div className='container mx-auto px-5'>
                <div className='flex md:flex-row flex-col md:gap-24 gap-8'>
                    ...
                    <div className='md:w-1/2 w-full md:py-20 py-5'>
                        <h2 className='text-3xl font-semibold text-[#222934] mb-10 '>Welcome to Rent-Canberra</h2>
                        <form className="space-y-4">
                            ...
                            <div className="flex items-start">
                                ...
                                <p className="text-sm text-gray-600">
                                    I agree to rent-canberra.com.au Term of Service and Privacy Policy
                                </p>
                            </div>
                        ...
                        <p className="text-center text-sm mt-4 text-gray-600">
                            Already have an account? <a className="text-[#1A1F3B] font-medium" href="/login">Login</a>
                        </p>
